...
public class optionpresentandduplicate {
	...
	public static void main(String[] args) {
		...
		driver.get("file:///F:/HTML%20files/Newlistbox.html");
		                   ...
		                   for(WebElement option : alloptions)
		                   {
		                	   ...
		                	   System.out.println(l1.containsKey("Manual"));
		                	   if((l1.containsKey("Manual"))){
		                		   if(l1.get("Manual")!=1 && (l1.get("Manual"))>1)
		                			   {
		                			   		System.out.println("Option is present and it's duplicate");
		                			   }else{
		                				   System.out.println("Option is present and it's not duplicate");
		                			   }
		                	   }
